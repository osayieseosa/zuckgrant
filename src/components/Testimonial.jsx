          ...
          <Swiper slidesPerView={1} ref={sliderRef}>
            <SwiperSlide>
              <SingleTestimonial
                ...
                reviewAlt="lineicon"
                details="After spending all my money on treatments and loosing my job and parents the program got me back to my feet and i still get people checking up on my monthly really love what you guys are doing"
                name="Larry Diamond"
            ...
            <SwiperSlide>
              <SingleTestimonial
                ...
                reviewImg="https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-01/lineicon.svg"
                reviewAlt="lineicon"
                details="They helped pay for my cousins treatment, we couldnt afford it and she is doing better today thanks to this program"
                name="Larry Diamond"
                position="Chief Executive Officer."
              />
            </SwiperSlide>
            <SwiperSlide>
              <SingleTestimonial
                ...
                reviewImg="https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-01/lineicon.svg"
                reviewAlt="lineicon"
                details="I am still recovering so i dont have a job and i dont leave the house these guys are covering all my bills and ensuring i have the best thank you oh so much"
                name="Larry Diamond"
                position="Chief Executive Officer."
              />
            </SwiperSlide>
