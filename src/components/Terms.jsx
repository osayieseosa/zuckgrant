...
const Terms = () => {
  ...
  return (
    <div className="px-5 sm:px-10 py-16">
      <div className="w-full max-w-4xl m-[0_auto] space-y-4">
        <h1 className="font-bold text-4xl">Terms and Conditions</h1>
        <p className="ml-1 text-xs font-bold text-yellow-600">
          Welcome to {companyName}!
        </p>
        <p className=" text-sm">
          These terms and conditions outline the rules and regulations for the
          use of {companyName}'s Website, located at
          <Link to="/" className="text-blue-500">
            {" "}
            https://www.zuckerreliefglobalgrant.org
          </Link>
          .
        </p>
        <p className=" text-sm">
        ...
        <h3 className="font-bold text-lg text-primary">Cookies</h3>
        <p className=" text-sm">
        ...
        <h3 className="font-bold text-lg text-primary">License</h3>
        <p className=" text-sm">
        ...
        <p className=" text-sm">You warrant and represent that:</p>
        <ul>
          <li>
        ...
        <h3 className="font-bold text-lg text-primary">iFrames</h3>
        <p className=" text-sm">
          Without prior approval and written permission, you may not create
          frames around our Webpages that alter in any way the visual
          presentation or appearance of our Website.
        </p>
        <h3 className="font-bold text-lg text-primary">Content Liability</h3>
        <p className=" text-sm">
        ...
        <h3 className="font-bold text-lg text-primary">Disclaimer</h3>
        <p className=" text-sm">
