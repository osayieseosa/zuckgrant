...
const NewUser = () => {
  ...
  useEffect(() => {
    if (successMsg) {
      setContent(
        <div className="alert alert-success text-slate-100">
          <span>
      ...
      setContent(
        <div className="alert alert-info text-slate-100 bg-red-500">
          <span>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMsg("New winner created successfully");
    } catch (err) {
      if (!err?.response) {
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <form className="card-body" onSubmit={handleSubmit}>
              <div className="toast toast-end">{content}</div>
              <input
                accepts="image/*"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Enter Country</span>
                </label>
                <select
