...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="w-full px-5 sm:px-0 h-max py-10">
      <div className="space-y-10 m-[0_auto] max-w-4xl">
        <div className="">
          <p className="font-bold text-2xl">Privacy Policy for {companyName}</p>
        </div>
        <div className="space-y-4">
          <h1 className="text-sm font-bold text-blue-500">Privacy Policy</h1>
          ...
          <h2 className="text-blue-500">Interpretation and Definitions</h2>
          <h3 className="text-blue-500">Interpretation</h3>
          <p className=" text-sm ">
          ...
          <h3 className="text-blue-500">Definitions</h3>
          ...
          <ul>
            ...
            <li>
              <p className=" text-sm ">
                <strong>Website</strong> refers to {companyName}, accessible
                from{" "}
                <Link className="text-primary" to="/">
                  https://www.zuckerglobalreliefgrant.org
                </Link>
              </p>
            </li>
            <li>
          ...
          <h3 className="text-blue-500">Types of Data Collected</h3>
          <h4 className="text-blue-500">Personal Data</h4>
          <p className=" text-sm ">
          ...
          <h4 className="text-blue-500">Usage Data</h4>
          <p className=" text-sm ">
          ...
          <h4 className="text-blue-500">Tracking Technologies and Cookies</h4>
          <p className=" text-sm ">
          ...
          <h3 className="text-blue-500">Use of Your Personal Data</h3>
          <p className=" text-sm ">
          ...
          <h3 className="text-blue-500">Retention of Your Personal Data</h3>
          <p className=" text-sm ">
          ...
          <h3 className="text-blue-500">Transfer of Your Personal Data</h3>
          <p className=" text-sm ">
          ...
          <h3 className="text-blue-500">Delete Your Personal Data</h3>
          <p className=" text-sm ">
          ...
          <h3 className="text-blue-500">Disclosure of Your Personal Data</h3>
          <h4 className="text-blue-500">Business Transactions</h4>
          <p className=" text-sm ">
          ...
          <h4 className="text-blue-500">Law enforcement</h4>
          <p className=" text-sm ">
          ...
          <h4 className="text-blue-500">Other legal requirements</h4>
          <p className=" text-sm ">
          ...
          <h3 className="text-blue-500">Security of Your Personal Data</h3>
          <p className=" text-sm ">
          ...
          <h2 className="text-blue-500">Children's Privacy</h2>
          <p className=" text-sm ">
          ...
          <h2 className="text-blue-500">Links to Other Websites</h2>
          <p className=" text-sm ">
          ...
          <ul>
            <li>
              ...
              <Link className="text-primary" to="/about">
                https://zuckerreliefglobalgrant.org/about
              </Link>
            </li>
          </ul>
        </div>
